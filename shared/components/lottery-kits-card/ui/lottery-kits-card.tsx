          ...
          <div className="absolute w-[90%] top-[50%] left-4 flex flex-col justify-center gap-3">
            <div className="flex items-center justify-between mt-[10px]">
              <div className="flex items-center gap-1">
                ...
                <span className="text-[#364059] leading-[20px] text-[15px]">50 билетов</span>
              </div>
              <p className="text-[#024cf8] leading-[20px] text-[15px]">Что внутри?</p>
            </div>
            <div>
              <h2 className="text-center h-[63px] text-[#364059] text-[18px] leading-6 font-bold">Разыграем от 100 млн ₽ на всех</h2>
            </div>
            <div className="flex items-center gap-2 h-[48px]">
              <Button className="w-full bg-[#2f41b0] rounded-xl hover:bg-[#2a399e] h-full">Купить · 300  ₽</Button>
